...
`err_desc` can be (but need not be) specified to alter the default bahaviour.
...
# Adding existing contracts to new contracs
...
Oftem you can gain a lot of security in your code if you can specify a 
